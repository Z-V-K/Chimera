...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox(const char* key, const char* label, bool* v);
    ...
    IMGUI_API bool          Hotkey(const char* widget_key, const char* label, int* k, bool* hold, const ImVec2& size_arg = ImVec2(0, 0));
    IMGUI_API void          Separator(const char* key, const char* label);
    IMGUI_API void          SameLineColorEdit(const char* key, float col[4], int type);
    // Widgets: Images
    ...
    IMGUI_API bool          BeginCombo(const char* key, const char* label, const char* preview_value, ImGuiComboFlags flags = 0);
    ...
    IMGUI_API bool          SliderFloat(const char* key, const char* label, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
    IMGUI_API bool          SliderFloat2(const char* label, float v[2], float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderFloat3(const char* label, float v[3], float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderFloat4(const char* label, float v[4], float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderAngle(const char* label, float* v_rad, float v_degrees_min = -360.0f, float v_degrees_max = +360.0f, const char* format = "%.0f deg", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt(const char* key, const char* label, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt2(const char* label, int v[2], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt3(const char* label, int v[3], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt4(const char* label, int v[4], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalar(const char* key, const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          ColorEdit4(const char* key, const char* label, float col[4], ImGuiColorEditFlags flags = 0);
    ...
    IMGUI_API bool          IsKeyDown(int key);                                            // is key being held.
    IMGUI_API bool          IsKeyPressed(ImGuiKey key, bool repeat = true);                     // was key pressed (went from !Down to Down)? if repeat=true, uses io.KeyRepeatDelay / KeyRepeatRate
    IMGUI_API bool          IsKeyPressed(int key);                     // was key pressed (went from !Down to Down)? if repeat=true, uses io.KeyRepeatDelay / KeyRepeatRate
    IMGUI_API bool          IsKeyReleased(ImGuiKey key);                                        // was key released (went from Down to !Down)?
    IMGUI_API bool          IsKeyReleased(int key);                                        // was key released (went from Down to !Down)?
...
enum ImGuiPopupFlags_
{
    ...
    ImGuiPopupFlags_BeginMenu = 1 << 10,
};
...
namespace Colors {
    inline ImColor AccentPrimary = { 255, 102, 39, 255 };
    inline ImColor AccentPrimaryDisabled = { 37, 37, 40, 255 };
    inline ImColor AccentSecondary = { 76, 90, 101, 255 };
    inline ImColor Background = { 20, 23, 28, 255 };
}
